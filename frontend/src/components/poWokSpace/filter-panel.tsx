...
import { usePoTypes } from "@/features/poWorkspace/usePoType";
        ...
        <div className="bg-card border-b border-border">
            <div className="px-2 py-1">
                <div className="flex items-center justify-between mb-3">
                    <h2 className="text-md font-medium text-accent-foreground">Filters & Search</h2>
                    {hasActiveFilters && (
                        <button
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                    ...
                    <div className="relative">
                        <label className="block text-xs text-accent-foreground mb-1">DUID</label>
                        <div className="relative">
                    ...
                    {/* PO Number Search */}
                    <div className="relative">
                        <label className="block text-xs text-accent-foreground mb-1">PO Number</label>
                        <div className="relative">
                            <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground" />
                            <input
                                type="text"
                    ...
                    {/* Project Code Search */}
                    <div className="relative">
                        <label className="block text-xs text-accent-foreground mb-1">Project Code</label>
                        <div className="relative">
                            <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground" />
                            <input
                                type="text"
                    ...
                    {/* Project Name Search */}
                    <div className="relative">
                        <label className="block text-xs text-accent-foreground mb-1">Project Name</label>
                        <div className="relative">
                            <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground" />
                            <input
                                type="text"
                    ...
                    {/* PM Search */}
                    <div className="relative">
                        <label className="block text-xs text-accent-foreground mb-1">PM</label>
                        <div className="relative">
                            <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-muted-foreground" />
                            <input
                                type="text"
                    ...
                    <div className="relative" ref={dropdownRef}>
                        <label className="block text-xs text-accent-foreground mb-1">PO Type</label>
                        <button
                    ...
                    {filters.poTypes.length > 0 && (
                        <div className="flex flex-wrap gap-1.5 mt-3 pt-3 border-t border-border">
                            <span className="text-xs text-accent-foreground mr-1">Active:</span>
