    ...
    return (
        ...
        >
            <div className="flex items-start gap-4">
                <div className={cn("mt-1 rounded-full p-2", isSuccess ? "bg-green-100 text-green-700" : "bg-amber-100 text-amber-700")}>
                    {isSuccess ? <CheckCircle2 size={20} /> : <Info size={20} />}
                </div>

                <div className="flex-1">
                    <div className="flex items-center justify-between">
                        <h3 className={cn("font-bold tracking-tight", isSuccess ? "text-green-900" : "text-slate-900")}>
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-3">
                        ...
                        <StatBox label="POs Failed" value={data.poFailed} color={data.poFailed > 0 ? "text-red-600" : "text-slate-400"} />
